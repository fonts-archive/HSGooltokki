...
[배포처 바로가기](https://blog.naver.com/hp0/222807721796)

&nbsp;

## 웹 폰트

사용하는 `font-family`의 이름은 `HSGooltokki`입니다.
...
@font-face {
    ...
    src: url('https://cdn.jsdelivr.net/gh/fonts-archive/HSGooltokki/HSGooltokki.woff2') format('woff2'),
         ...
         url('https://cdn.jsdelivr.net/gh/fonts-archive/HSGooltokki/HSGooltokki.otf') format('opentype'),
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/HSGooltokki/subsets/HSGooltokki-dynamic-subset.css" type="text/css"/>
```

### CSS

```css
@import url('https://cdn.jsdelivr.net/gh/fonts-archive/HSGooltokki/subsets/HSGooltokki-dynamic-subset.css');
```
...
```css
font-family: "HSGooltokki", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;
```
